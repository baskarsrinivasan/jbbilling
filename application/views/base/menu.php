                            ...
                            <li class="language">
                                <div class="btn-group languages-block ">
                                    <form action="<?php echo base_url()?>" method="post" enctype="multipart/form-data" id="bt-language">
                                        <a class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                                            <img src="<?php echo base_url()?>assets/front_end/image/catalog/flags/gb.png" alt="English" title="English">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="logo"><a href="<?php echo base_url()?>"><img src="<?php echo base_url()?>assets/front_end/image/catalog/logo2.png" title="SRI JB HEALTH CARE LOGO" alt="SRI JB HEALTH CARE LOGO" /></a></div>
                </div>
                <!-- //end Logo -->
                <!-- Search -->
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center" style="width:70px">
                                                    <a href="product.html">
                                                        <img src="<?php echo base_url()?>assets/front_end/image/catalog/demo/product/80/1.jpg" style="width:70px" alt="Yutculpa ullamcon" title="Yutculpa ullamco" class="preview">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width:70px">
                                                    <a href="product.html">
                                                        <img src="<?php echo base_url()?>assets/front_end/image/catalog/demo/product/80/2.jpg" style="width:70px" alt="Xancetta bresao" title="Xancetta bresao" class="preview">
                                                    </a>
                                                </td>
                                            ...
                                            <ul class="megamenu" data-transition="slide" data-animationtime="250">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <a href="<?php echo base_url()?>" class="image-link"> 
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="<?php echo base_url()?>assets/front_end/image/catalog/menu/home-1.jpg" alt="">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="home2.html" class="image-link"> 
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="<?php echo base_url()?>assets/front_end/image/catalog/menu/home-2.jpg" alt="">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="home3.html" class="image-link"> 
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="<?php echo base_url()?>assets/front_end/image/catalog/menu/home-3.jpg" alt="">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <a href="html_with_RTL/<?php echo base_url()?>" class="image-link"> 
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="<?php echo base_url()?>assets/front_end/image/catalog/menu/rtl.jpg" alt="">
                                                                ...
                                                                <!-- <div class="col-md-15">
                                                                    <a href="#" class="image-link"> 
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="<?php echo base_url()?>assets/front_end/image/demo/feature/comming-soon.png" alt="">
                                                ...
                                                <li class="with-sub-menu hover">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        ...
                                                        <img class="label-hot" src="<?php echo base_url()?>assets/front_end/image/catalog/menu/new-icon.png" alt="icon items">
                                                        <b class="caret"></b>
                                                    </a>
                                                ...
                                                <li class="with-sub-menu hover">
                                                    ...
                                                    <a href="#" class="clearfix">
                                                        ...
                                                        <img class="label-hot" src="<?php echo base_url()?>assets/front_end/image/catalog/menu/hot-icon.png" alt="icon items">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="row">
                                                                        <div class="col-md-3 img img1">
                                                                            <a href="#"><img src="<?php echo base_url()?>assets/front_end/image/catalog/menu/megabanner/image-1.jpg" alt="banner1"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img2">
                                                                            <a href="#"><img src="<?php echo base_url()?>assets/front_end/image/catalog/menu/megabanner/image-2.jpg" alt="banner2"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img3">
                                                                            <a href="#"><img src="<?php echo base_url()?>assets/front_end/image/catalog/menu/megabanner/image-3.jpg" alt="banner3"></a>
                                                                        </div>
                                                                        <div class="col-md-3 img img4">
                                                                            <a href="#"><img src="<?php echo base_url()?>assets/front_end/image/catalog/menu/megabanner/image-4.jpg" alt="banner4"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
