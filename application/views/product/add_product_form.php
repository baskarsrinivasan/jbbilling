                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control text-right" id="mrp_price" name="mrp_price" type="text" required="" placeholder="0.00" tabindex="5" min="0">
                                    </div>
                                </div> 
                            </div>
                            ...
                            <table class="table table-bordered table-hover"  id="product_table">
                                ...
                                <tbody id="proudt_item">
                                    <tr class="">
                                        ...
                                        <td class="">
                                            <input type="text" tabindex="6" class="form-control text-right supplier_price" name="supplier_price[]" placeholder="0.00"  required  min="0"/>
                                        </td>
