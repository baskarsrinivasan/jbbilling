...
class Ccategory extends CI_Controller {
    ...
    public function insert_category() {
        ...
        if ($_FILES['user_file']['name']) {
            //echo UPLOAD_DIRECTORY;exit();
                            
                            $upload_path = "./my-assets/image/category/";
                            $upload_path_table = base_url('my-assets/image/category/');
                            ...
                            $bannerpath = $upload_path_table. $bannername;
                            move_uploaded_file($_FILES["user_file"]["tmp_name"], $bannerpath);
                            $cover_pic =  $bannerpath;
